...
#define asciimap(map, fill) char map[128] = { fill };
...
public:
    int lengthOfLongestSubstring(string s) {
        ...
        vi seen(256, -1); // remember the last seeing index of the corresonding character
        int start = -1; // beginning of the substring
        int longest = 0;
