...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        /**
         * nums1 is longer and nums2 is shorter.
         */
        ...
        /**
         * The reason is that on the shorter array, all positions are possible 
         * cut locations for median, but on the longer array, the positions that 
         * are too far left or right are simply impossible for a legitimate cut.
         */
        if (n < m) {
