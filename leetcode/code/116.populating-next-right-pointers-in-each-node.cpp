...
public:
    Node* connect(Node* root) {
        ...
        while (root) {
            ...
            // breaks either reaches the bottom or reaches the end of the level
            while (curr) {
                if (!curr->left) {
                    break;
                }
                ...
                // if there are next node in the current level, connect current right to the next left.
                if (curr->next) {
            ...
            // current level is finished, go to the next level.
            root = root->left;
        }
