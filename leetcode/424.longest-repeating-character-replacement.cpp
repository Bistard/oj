...
public:
    int characterReplacement(string s, int k) {
        ...
        /**
         * "n - start" is the final size of the sliding window. Size of the 
         * sliding windows is maintained to fit the longest possible required 
         * substring throughout the loop.
         */
        return n - start;
    }
};
